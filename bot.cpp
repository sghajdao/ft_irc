...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/03 17:25:36 by mlalouli          #+#    #+#             */
/*   Updated: 2023/04/03 18:00:39 by mlalouli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Server::sendMessage_bot(string nickname, const struct kevent& event)
{
	int sendBytes;
...
void Server::bot(const struct kevent& event) {
